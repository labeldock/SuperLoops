...
#elif defined(ARDUINO_ESP32_DEV) // e.g. Waveshare ESP32 Driver Board
using CURRENT_DISPLAY_CLASS = GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)>;
CURRENT_DISPLAY_CLASS display(GxEPD2_DRIVER_CLASS(/*CS=*/ 15, /*DC=*/ 27, /*RST=*/ 26, /*BUSY=*/ 25));
#else
